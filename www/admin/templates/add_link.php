...
<form action="" method="post">	
	<table class="add_edit_page" cellspacing="0" cellpadding="0">
	  <tr>
		<td class="add-edit-txt">Название страницы:&nbsp;<span class="star">*</span></td>
	  ...
	  <tr>
		...
		<td><input class="num-text" type="text" name="link_position" value="<?=$_SESSION['add_link']['link_position']?>" /></td>
	  </tr>
	   <tr>
